...
tf.app.flags.DEFINE_integer('input_mode', 2,
                            '0:absolute,1:optical,2:concat.')

tf.app.flags.DEFINE_integer('output_mode', 0,
                            '0:softmax,1:lstm,2:crf.')
...
def _get_variables_to_train():
  ...
  Returns: A list of variables to train by the optimizer.
  """
  ...
  with tf.Graph().as_default():
    ...
    def clone_fn(batch_queue):
      ...
      if FLAGS.output_mode == 0:
        ...
        log_likelihood, transition_params = tf.contrib.crf.crf_log_likelihood(logits, labels, tf.constant([8]))
